...
import com.reachout.slackapp.Repository.GrievanceRepo;
...
public class Grievance {
	...
	public String postForumCommand(@FormParam("token") String token,
		...
		return grepo.newGrievanceMessage(token, team_id, team_domain, channel_id, channel_name, user_id, user_name, command, text, response_url);
//		return returnStatus;
